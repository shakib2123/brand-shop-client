const Update = () => {
  return (
    <div className="bg-base-200">
      <div className="max-w-7xl mx-auto h-[60vh] flex justify-center items-center my-8">
        <div className="text-center ">
          <h2 className="text-2xl md:text-5xl font-semibold">
            Stay with us for latest update.
          </h2>
          <p className="text-lg mt-3">
            Stay with us for latest update what we do what you want it help to
